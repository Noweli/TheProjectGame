...
public class PacWoman extends Enemy {
	private float stateTime;
    private Animation<TextureRegion> walkAnimation;
    private Array<TextureRegion> frames;

	public PacWoman(PlayScreen screen, float x, float y) {
		super(screen, x, y);
		
		setRegion(screen.getEnemyAtlas2().findRegion("pacwoman1"));
        ...
        for(int i = 0 ; i <= 35; i+=35)
            frames.add(new TextureRegion(getTexture(), i, 2, 32, 32));
